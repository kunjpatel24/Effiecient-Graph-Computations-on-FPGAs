set moduleName top_function_Pipeline_7
set isTopModule 0
...
set C_modelName {top_function_Pipeline_7}
set C_modelType { void 0 }
set C_modelArgList {
	{ visited int 1 regular {array 20 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ visited_address0 sc_out sc_lv 5 signal 0 } 
	{ visited_ce0 sc_out sc_logic 1 signal 0 } 
	{ visited_we0 sc_out sc_logic 1 signal 0 } 
	{ visited_d0 sc_out sc_lv 1 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	visited { ap_memory {  { visited_address0 mem_address 1 5 }  { visited_ce0 mem_ce 1 1 }  { visited_we0 mem_we 1 1 }  { visited_d0 mem_din 1 1 } } }
}
