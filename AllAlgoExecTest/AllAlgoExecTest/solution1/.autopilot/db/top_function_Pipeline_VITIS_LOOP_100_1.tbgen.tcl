set moduleName top_function_Pipeline_VITIS_LOOP_100_1
set isTopModule 0
...
set C_modelName {top_function_Pipeline_VITIS_LOOP_100_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_reload30 int 32 regular  }
	{ visited int 1 regular {array 20 { 2 2 } 1 1 }  }
	{ nodeQueue int 5 regular {array 20 { 2 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_reload30", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "visited", "interface" : "memory", "bitwidth" : 1, "direction" : "READWRITE"} , 
 	{ "Name" : "nodeQueue", "interface" : "memory", "bitwidth" : 5, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ p_reload30 sc_in sc_lv 32 signal 0 } 
	{ visited_address0 sc_out sc_lv 5 signal 1 } 
	...
	{ visited_address1 sc_out sc_lv 5 signal 1 } 
	{ visited_ce1 sc_out sc_logic 1 signal 1 } 
	{ visited_we1 sc_out sc_logic 1 signal 1 } 
	{ visited_d1 sc_out sc_lv 1 signal 1 } 
	{ visited_q1 sc_in sc_lv 1 signal 1 } 
	{ nodeQueue_address0 sc_out sc_lv 5 signal 2 } 
	{ nodeQueue_ce0 sc_out sc_logic 1 signal 2 } 
	{ nodeQueue_we0 sc_out sc_logic 1 signal 2 } 
	{ nodeQueue_d0 sc_out sc_lv 5 signal 2 } 
	{ nodeQueue_q0 sc_in sc_lv 5 signal 2 } 
	{ p_out sc_out sc_lv 32 signal 3 } 
	{ p_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ adjacencyList_18_address0 sc_out sc_lv 5 signal 4 } 
	{ adjacencyList_18_ce0 sc_out sc_logic 1 signal 4 } 
	{ adjacencyList_18_q0 sc_in sc_lv 1 signal 4 } 
	{ adjacencyList_16_address0 sc_out sc_lv 5 signal 5 } 
	{ adjacencyList_16_ce0 sc_out sc_logic 1 signal 5 } 
	{ adjacencyList_16_q0 sc_in sc_lv 1 signal 5 } 
	{ adjacencyList_15_address0 sc_out sc_lv 5 signal 6 } 
	{ adjacencyList_15_ce0 sc_out sc_logic 1 signal 6 } 
	{ adjacencyList_15_q0 sc_in sc_lv 1 signal 6 } 
	{ adjacencyList_13_address0 sc_out sc_lv 5 signal 7 } 
	{ adjacencyList_13_ce0 sc_out sc_logic 1 signal 7 } 
	{ adjacencyList_13_q0 sc_in sc_lv 1 signal 7 } 
	{ adjacencyList_11_address0 sc_out sc_lv 5 signal 8 } 
	{ adjacencyList_11_ce0 sc_out sc_logic 1 signal 8 } 
	{ adjacencyList_11_q0 sc_in sc_lv 1 signal 8 } 
	{ adjacencyList_7_address0 sc_out sc_lv 5 signal 9 } 
	{ adjacencyList_7_ce0 sc_out sc_logic 1 signal 9 } 
	{ adjacencyList_7_q0 sc_in sc_lv 1 signal 9 } 
	{ adjacencyList_4_address0 sc_out sc_lv 5 signal 10 } 
	{ adjacencyList_4_ce0 sc_out sc_logic 1 signal 10 } 
	{ adjacencyList_4_q0 sc_in sc_lv 1 signal 10 } 
	{ adjacencyList_3_address0 sc_out sc_lv 5 signal 11 } 
	{ adjacencyList_3_ce0 sc_out sc_logic 1 signal 11 } 
	{ adjacencyList_3_q0 sc_in sc_lv 1 signal 11 } 
	{ adjacencyList_2_address0 sc_out sc_lv 5 signal 12 } 
	{ adjacencyList_2_ce0 sc_out sc_logic 1 signal 12 } 
	{ adjacencyList_2_q0 sc_in sc_lv 1 signal 12 } 
	...
	{ adjacencyList_1_address0 sc_out sc_lv 5 signal 15 } 
	{ adjacencyList_1_ce0 sc_out sc_logic 1 signal 15 } 
	{ adjacencyList_1_q0 sc_in sc_lv 1 signal 15 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_reload30", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "p_reload30", "role": "default" }} , 
 	{ "name": "visited_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "visited", "role": "address0" }} , 
 	...
 	{ "name": "visited_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "visited", "role": "address1" }} , 
 	{ "name": "visited_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "visited", "role": "ce1" }} , 
 	{ "name": "visited_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "visited", "role": "we1" }} , 
 	{ "name": "visited_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "visited", "role": "d1" }} , 
 	{ "name": "visited_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "visited", "role": "q1" }} , 
 	{ "name": "nodeQueue_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "nodeQueue", "role": "address0" }} , 
 	{ "name": "nodeQueue_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "nodeQueue", "role": "ce0" }} , 
 	{ "name": "nodeQueue_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "nodeQueue", "role": "we0" }} , 
 	{ "name": "nodeQueue_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "nodeQueue", "role": "d0" }} , 
 	{ "name": "nodeQueue_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "nodeQueue", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	p_reload30 { ap_none {  { p_reload30 in_data 0 32 } } }
	visited { ap_memory {  { visited_address0 mem_address 1 5 }  { visited_ce0 mem_ce 1 1 }  { visited_we0 mem_we 1 1 }  { visited_d0 mem_din 1 1 }  { visited_q0 in_data 0 1 }  { visited_address1 MemPortADDR2 1 5 }  { visited_ce1 MemPortCE2 1 1 }  { visited_we1 MemPortWE2 1 1 }  { visited_d1 MemPortDIN2 1 1 }  { visited_q1 in_data 0 1 } } }
	nodeQueue { ap_memory {  { nodeQueue_address0 mem_address 1 5 }  { nodeQueue_ce0 mem_ce 1 1 }  { nodeQueue_we0 mem_we 1 1 }  { nodeQueue_d0 mem_din 1 5 }  { nodeQueue_q0 in_data 0 5 } } }
