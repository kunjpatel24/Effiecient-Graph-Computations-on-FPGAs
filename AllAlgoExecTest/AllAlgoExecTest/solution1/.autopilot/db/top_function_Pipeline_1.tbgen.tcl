set moduleName top_function_Pipeline_1
set isTopModule 0
...
set C_modelName {top_function_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ visited_3 int 1 regular {array 20 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "visited_3", "interface" : "memory", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	visited_3 { ap_memory {  { visited_3_address0 mem_address 1 5 }  { visited_3_ce0 mem_ce 1 1 }  { visited_3_we0 mem_we 1 1 }  { visited_3_d0 mem_din 1 1 } } }
}
