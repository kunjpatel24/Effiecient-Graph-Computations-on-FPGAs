...
__attribute__((sdx_kernel("top_function", 0))) void top_function(int& newListValue, int& totalTraversalSize, int& signal);
# 3 "Graph.cpp" 2
...
void performBFS(int startNode) {
    ...
    VITIS_LOOP_37_1: while (front != rear) {
        int node = queue[++front];
        allTraversal[traversalSize++] = node;

        VITIS_LOOP_41_2: for (int i = 1; i < 20; ++i) {
...
void performDFS(int startNode) {
    ...
    VITIS_LOOP_58_1: while (top != -1) {
        int node = stack[top--];
        allTraversal[traversalSize++] = node;

        VITIS_LOOP_62_2: for (int i = 20 - 1; i >= 1; --i) {
            if (adjacencyList[node][i] == 1 && !visited[i]) {
                visited[i] = true;
                stack[++top] = i;
            }
...
void performNormalTraversal(int startNode) {
    ...
    VITIS_LOOP_79_1: while (top != -1) {
        int node = stack[top--];
        allTraversal[traversalSize++] = node;

        VITIS_LOOP_83_2: for (int i = 20 - 1; i >= 1; --i) {
            if (adjacencyList[node][i] == 1 && !visited[i]) {
                visited[i] = true;
                stack[++top] = i;
            }
...
void performPageRankTraversal(int startNode) {
    ...
    VITIS_LOOP_100_1: while (front != rear) {
        int node = nodeQueue[++front];
        allTraversal[traversalSize++] = node;

        VITIS_LOOP_104_2: for (int i = 1; i < 20; ++i) {
            if (adjacencyList[node][i] == 1 && !visited[i]) {
                visited[i] = true;
                nodeQueue[++rear] = i;
            }
...
__attribute__((sdx_kernel("top_function", 0))) void top_function(int& newListValue, int& totalTraversalSize, int& signal) {
#line 18 "C:/Users/kunjp/Desktop/EE800/new/AllAlgoExecTest/AllAlgoExecTest/AllAlgoExecTest/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=top_function
# 113 "Graph.cpp"

#line 7 "C:/Users/kunjp/Desktop/EE800/new/AllAlgoExecTest/AllAlgoExecTest/AllAlgoExecTest/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=top_function
# 113 "Graph.cpp"
    ...
    VITIS_LOOP_141_1: for (int i = index + 1; i < traversalSize; ++i) {
